<?php
function activitas_init() {
  elgg_register_page_handler('activitas', 'activitas_page_handler');
}
elgg_register_event_handler('init', 'system', 'activitas_init');

function activitas_page_handler($page)
{
  if (!isset($page[0])) {
		$page = array('all');
	}
